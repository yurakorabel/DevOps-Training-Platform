...
<main class="interesting-page task-page container">
    <div class="container">
        <form action="creating-post.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="main_text" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="image_url" required>
            </div>
